...
export async function listCards({ category, grade, sort = "newest", search = "", page = 1, includeSold = false, soldOnly = false, isGraded = null } = {}) {
...
export async function createCard({ title, category, grade, cert, price, imageUrl, isGraded = true, condition = null }) {
