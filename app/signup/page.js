  ...
  return (
    <div className="wrap" style={{ maxWidth: 440, padding: "72px 0 100px" }}>
      ...
      <p style={{ color: "var(--grey)", fontSize: 14.5, margin: "0 0 32px" }}>
        Track orders and hear about new listings first.
      </p>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <p style={{ fontSize: 12, color: "var(--grey-dim)", marginTop: 6 }}>At least 8 characters.</p>

        <label style={{ display: "flex", alignItems: "center", gap: 10, marginTop: 20, fontSize: 13.5, color: "var(--grey)" }}>
          <input type="checkbox" checked={subscribe} onChange={(e) => setSubscribe(e.target.checked)} />
          Email me about new graded cards and drops
        </label>
      ...
      <p style={{ fontSize: 13.5, color: "var(--grey)", marginTop: 24 }}>
        Already have an account? <Link href="/signin" style={{ color: "var(--gold-light)" }}>Sign in</Link>
      </p>
    </div>
  );
}
